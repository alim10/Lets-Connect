package com.alim.letsconnect.convention.task
        ...
        val refreshTask = target.tasks.register("RefreshDependencies") {
            ...
            target.configurations.forEachIndexed { index, config ->
                ...
                config.dependencies.forEach { dependency ->
                    /**
                     * @sample [com.alim.letsconnect:SHCoreModuleGMS:3.22.0]
                     * @param [com.alim.letsconnect] Represent dependency GROUP
                     * @param [com.alim.letsconnect]  Represent dependency NAME
                     * @param [1.0.1]           Represent dependency VERSION
                     * And refresh them with new fresh install
                     * And <install fresh again>
                     * */
                    if (dependency.group?.contains("com.alim.letsconnect") == false) return@forEach //USE IT CAREFULLY
