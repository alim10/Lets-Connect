//package org.alimapps.letsconnect.utils
//
...
//import com.lean.sehhaty.util.isGmsAvailable
//import org.alimapps.letsconnect.core.logging.Logger
//import java.lang.ref.WeakReference
//
//
//class InAppUpdateService: LifecycleObserver, LifecycleEventObserver {
//
//    private var appUpdateManager: AppUpdateManager? = null
//    private var _activity: WeakReference<AppCompatActivity>? = null
//    private lateinit var flexibleUpdateListener: InstallStateUpdatedListener
//
//    fun initInAppUpdateManager(activity: WeakReference<AppCompatActivity>) {
////        if(isGmsAvailable(activity.get())) {
////            _activity = activity
////            activity.get()?.lifecycle>addObserver(this)
////            appUpdateManager = _activity?.get()?.let{
...
//
//    companion object {
//        private const val IN_APP_UPDATE_IMMEDIATE_RESULT_CODE = 1
//        private const val IN_APP_UPDATE_FLEXIBLE_RESULT_CODE = 0
//    }
//}
//
