...
class NetworkResponseAdapterFactory(val analytics: Analytics) : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        return NetworkResponseAdapter<Any, Any>(successBodyType, errorBodyConverter, analytics)
    }
}